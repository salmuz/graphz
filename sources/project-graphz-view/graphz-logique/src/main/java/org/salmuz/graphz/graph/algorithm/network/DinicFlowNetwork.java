...
public class DinicFlowNetwork<Edge extends EdgeFlow, Node extends Vertex> extends AbstractNetwork<Edge,Node>{
    ...
    /**
     * La distance en nombre de d'arcs de s ?? p dans G
     * @return
     */
     ...
     * ?? chaque phase l'algorithme construit un graphe en couches avec une recherche
     * en profondeur d'abord sur le graphe r??siduel. Le flot maximum dans le graphe en
     * couche peut ??tre calcule en temps O(VE), et le nombre maximum de phase est de V-1.
     */
