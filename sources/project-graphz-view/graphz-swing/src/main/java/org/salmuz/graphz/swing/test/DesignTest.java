 ...
 *
 */
package org.salmuz.graphz.swing.test;

import org.salmuz.graphz.swing.design.DesignGeometric2D;
...
public class DesignTest {
    ...
    public static void testDesignArrow() {
        SwingUtilities.invokeLater(new Runnable() {
            ...
            //ShapeGeometric arrows = new org.salmuz.graphz.structure.geometric.plane.Rectangle(start,100.0,100.0);
