...
public class Line2DOperationImpl implements LineOperation{
   ...
   * @parameter Line line  elle contient comme parameter une ligne
   * @return midPoint elle retourn a un point
   */
    ...
    /**
     * cette methode est implementé dans la class LineOperation
     *  @return  size elle retourn la taille ou la distance d'un point
     *  @parameter Line line
     */
